...
<html lang="en">
  <head>
<title>Aremo Gemini | CONTACT-US</title>
    <meta charset="utf-8">
        ...
        <div class="container mt-5">
          <div class="row block-9">
            ...
            <div class="col-md-6 ftco-animate">
              <form action="" method="post" class="contact-form this_is-my_appointment">
              	<div class="row">
              		<div class="col-md-6">
                ...
                <div class="form-group">
                  <input type="submit" value="Send Message" class="btn btn-primary py-3 px-5 contact_btn">
                </div>
              </form>
