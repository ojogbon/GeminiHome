...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/1.jpg');" data-stellar-background-ratio="0.5">
    	...
    	<div class="container">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="media d-block text-center block-6 services">
              ...
              <div class="media-body">
                <h3 class="heading">Story Telling</h3>
                <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 ftco-animate">
            <div class="media d-block text-center block-6 services">
              ...
              <div class="media-body">
                <h3 class="heading">Art Reviews</h3>
                <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
              </div>
            </div>
          </div>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Our Reviews</h2>
            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
          </div>
        </div>
        <div class="row reviws-all-for-it">
			...
			<div class="container">
				<div class="row justify-content-end">
					<div class="col-md-5 discount ftco-animate">
						<h3>The art that confort the </h3>
						<h2 class="mb-4">mind and soul</h2>
						<p class="mb-4">This is art you don't want to miss, stay connected and stay relaxed. We gat you covered all thw way!</p>
						<p><a href="index.php#Appointments" class="btn btn-white btn-outline-white px-4 py-3">Book Now</a></p>
					</div>
				</div>
			</div>
		</section>
    	...
    	<div class="container">
    		<div class="row d-md-flex align-items-center">
	    		...
	    		<div class="col-md-6 appointment pl-md-5 ftco-animate">
	    			...
	    			<form method="post" class="appointment-form this_is-my_appointment">
	            ...
	            <div class="row form-group d-flex">
	            	<div class="col-md-6">
	            		<div class="input-wrap">
		            		...
		            		<input type="text"  name="dateit"  required id="appointment_date" class="form-control" placeholder="Date">
	            		</div>
	            	</div>
	            	<div class="col-md-6">
				...
				<div class="row form-group d-flex">
	            	<div class="col-md-12">
	            		<div class="input-wrap">
		            		<input type="email"  name="email"  required id="appointment_date" class="form-control" placeholder="Email..">
	            		</div>
	            	</div>
	            	
	            </div>
	            <div class="form-group">
	              <textarea   name="message" required id="" cols="30" rows="3" class="form-control" placeholder="Message"></textarea>
	            </div>
	            <div class="form-group">
	              <button type="submit" name="sendmyorder" class="btn btn-white btn-outline-white py-3 px-4 myorder_btn"> Order</button>
	            </div>
  ...
  <script type="module" src="js/authored/appointment.js"></script>
  <script type="module" src="js/authored/Review.js"></script>
  <script type="module" src="js/authored/Work.js"></script>
